...
import com.gypso.gypsogest.repository.TransactionRepository;
...
/**
 * REST controller for managing {@link com.gypso.gypsogest.domain.Transaction}.
 */
@RestController
        ...
        Optional<Transaction> result = transactionRepository
            ...
            .map(existingTransaction -> {
                ...
                if (transaction.getPaymentCode() != null) {
                    existingTransaction.setPaymentCode(transaction.getPaymentCode());
                }
