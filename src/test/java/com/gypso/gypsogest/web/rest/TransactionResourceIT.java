...
class TransactionResourceIT {
    ...
    private static final PaymentType DEFAULT_TYPE = PaymentType.Cheque;
    private static final PaymentType UPDATED_TYPE = PaymentType.Effet;
    ...
    void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getPaymentCode()).isEqualTo(DEFAULT_PAYMENT_CODE);
    ...
    void checkPaymentCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = transactionRepository.findAll().size();
        // set the field null
        transaction.setPaymentCode(null);
    ...
    void putExistingTransaction() throws Exception {
        ...
        updatedTransaction.date(UPDATED_DATE).amount(UPDATED_AMOUNT).paymentCode(UPDATED_PAYMENT_CODE).type(UPDATED_TYPE);
        ...
        assertThat(testTransaction.getPaymentCode()).isEqualTo(UPDATED_PAYMENT_CODE);
    ...
    void partialUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.paymentCode(UPDATED_PAYMENT_CODE).type(UPDATED_TYPE);
    ...
    void fullUpdateTransactionWithPatch() throws Exception {
        ...
        partialUpdatedTransaction.date(UPDATED_DATE).amount(UPDATED_AMOUNT).paymentCode(UPDATED_PAYMENT_CODE).type(UPDATED_TYPE);
