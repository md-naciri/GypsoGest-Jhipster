...
import com.gypso.gypsogest.repository.SaleRepository;
...
class SaleResourceIT {
    ...
    public static Sale createEntity(EntityManager em) {
        Sale sale = new Sale().date(DEFAULT_DATE);
        return sale;
    }
    ...
    public static Sale createUpdatedEntity(EntityManager em) {
        Sale sale = new Sale().date(UPDATED_DATE);
        return sale;
    }
